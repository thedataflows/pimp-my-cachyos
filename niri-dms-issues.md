...
12. [x] Phone Connect dms plugin not detecting kdeconnectd daemon. Fixed setting user service for kdeconnectd, and binding it to dms.service. Also, autostarting `KDE Connect Indicator` was conflicting with the dms plugin.
